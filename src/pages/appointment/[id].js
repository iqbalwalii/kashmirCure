          ...
          <Table striped bordered hover responsive>
            ...
            <tbody>
                ...
                <td>
                  ...
                  {data?.appointment_status === "Cancel" ? (
                    <div>
                      <span>
                        reason:&nbsp;
                        {data?.cancel_details?.cancel_reason}
                      </span>
                      <br />
                      <span>
                        date:&nbsp;
              ...
              <tr>
                ...
                <td>
                  {data?.payment_status[data?.payment_status.length - 1]?.state}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  start time:- &nbsp;
                  {data?.started_at ? (
                    <span>{data?.started_at.slice(11, 19)}</span>
                  ) : (
                    ""
                  )}
                  <br /> end time:- &nbsp;
                  {data?.ended_at ? data.ended_at.slice(11, 19) : ""}
                </td>
              </tr>
              {/* <tr>
                <td>Followed Up</td>
